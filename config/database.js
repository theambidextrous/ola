...
// console.log(mongoDB);
var username = process.env.MONGODB_USER;//MONGO_DB_USERNAME;
var password = process.env.MONGODB_PASSWORD;//MONGO_DB_PASSWORD;
var host = process.env.MONGODB_SERVICE_HOST;
var port = process.env.MONGODB_SERVICE_PORT;
var database = process.env.MONGODB_DATABASE;//MONGO_DB_DATABASE;
